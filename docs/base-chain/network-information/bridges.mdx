...
See the [sample code repository](https://github.com/base/guides/tree/main/bridge/native) to see how to bridge ETH and ERC-20s from Ethereum to Base.
...
If you have an ERC-20 token deployed on Ethereum and want to enable bridging to Base, see our guide on [Bridging an L1 Token to Base](https://docs.optimism.io/app-developers/bridging/standard-bridge). This covers deploying your token on Base using the standard bridge contracts and getting it listed on the Superchain token list.
